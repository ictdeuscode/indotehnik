...
@section('breadcrumbs')
    {{ Breadcrumbs::render('edit_mastermesin_title', $mastermesin ) }}
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('mastermesin.update', ['mastermesin' => $mastermesin]) }}" method="POST">
                        <!-- title -->
                        @method('PUT')
                        @csrf
                        <fieldset>
                            <div class="form-group row inputGroupContainer">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('kode', $mastermesin->kode) }}"
                            ...
                            <div class="form-group row inputGroupContainer">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('nama', $mastermesin->nama) }}"
                            ...
                            <div class="form-group row inputGroupContainer">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('keterangan', $mastermesin->keterangan) }}"
                            ...
                            <div class="form-group row inputGroupContainer">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{ old('poin', $mastermesin->poin) }}"
                            ...
                            <div class="form-group row inputGroupContainer">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="checkbox" value="1" @if($mastermesin->is_gudang_finish == 1) checked @endif
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <input type="checkbox" value="1"
                                            class="form-control @error('is_gudang_kirim') is-invalid @enderror" @if($mastermesin->is_gudang_kirim == 1) checked @endif id="is_gudang_kirim"
