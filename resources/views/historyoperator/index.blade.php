...
@section('breadcrumbs')
    {{ Breadcrumbs::render('historyoperator') }}
@endsection
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-7">
                        <a class="form-inline" href="{{ route('exporthistoryoperator') }}">
                    ...
                    <div class="col-md-4">
                        <div class="form-inline">
                            <form action="<?php echo url('dashboard/historyoperator'); ?>">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    @include('historyoperator.listhistoryoperator')
                </ul>
            </div>
        </div>
    </div>
